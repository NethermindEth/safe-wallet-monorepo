...
describe('Tx history tests 1', () => {
  ...
  beforeEach(() => {
    cy.intercept(
      ...
      (req) => {
        req.url = `https://safe-ui.surge.wtf/cgw/v1/chains/11155111/safes/0x5912f6616c84024cD1aff0D5b55bb36F5180fFdb/transactions/history?timezone=Europe/Berlin&trusted=false&cursor=limit=100&offset=1`
        req.continue()
      },
    ).as('allTransactions')
